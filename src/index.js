...
function generatePoem(event) {
    ...
    let context = "you are an english poem writer and love to write poems. your mission is to generate a 4 line in basic HTML. make sure to follow the user instructions below.";
